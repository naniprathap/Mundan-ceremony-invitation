...
var countDownDate = new Date("Mar 28, 2024 09:32:00").getTime();
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("time").innerHTML = "May my son be forever blessed with happiness, health, and a life filled with joy.";
    }
}, 1000);
...
console.log('\n\n%c SAVE THE DATE: 28th Mar, 2024!', styles);
